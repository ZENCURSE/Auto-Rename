        ...
        if data == "home":
            await query.message.edit_text(
                ...
                reply_markup=InlineKeyboardMarkup([
                    ...
                    [InlineKeyboardButton('• ᴜᴘᴅᴀᴛᴇs', url='https://t.me/cantarellabots'), InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ •', url='https://t.me/Code_Rips_Support')],
            ...
            await query.message.edit_text(
                ...
                disable_web_page_preview=True,
                reply_markup=InlineKeyboardMarkup([
                    [InlineKeyboardButton("• ʙᴀᴄᴋ", callback_data="help"), InlineKeyboardButton("ᴏᴡɴᴇʀ •", url='https://t.me/ZENCURSE')]
                ])
            )
